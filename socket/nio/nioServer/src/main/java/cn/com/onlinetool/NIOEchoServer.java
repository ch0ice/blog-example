...
/**
 * @author choice
 * @description: NIO（同步非阻塞IO）
 * 使用selector模型（选择器）,负责管理所有channel，定时轮询线程工作状态，SelectionKey(OP_ACCEPT OP_CONNECT OP_READ OP_WRITE)
...
public class NIOEchoServer {
    private static class EchoClientHandler implements Runnable {
        ...
        public EchoClientHandler(SocketChannel clientChannel) {
            ...
            // 严格意义上来讲，当已经成功的连接上了服务器，并且需要进行进一步处理之前,要发送一些消息给客户端
        }
        @Override
        public void run() {
