...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        findBigSequence1(src, len);
        findBigSequence2(src, len);
        findBigSequence3(src);
     ...
     * @return
     */
    private static int[] findBigSequence1(int[] src, int size) {
     ...
     * @return
     */
    private static int[] findBigSequence2(int[] src, int size) {
     ...
     * @return
     */
    private static int[] findBigSequence3(int[] src) {
